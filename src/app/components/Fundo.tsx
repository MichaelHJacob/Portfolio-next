...
export default function Fundo() {
  return (
    ...
    <span className=" h-screen w-[33vw] bg-black/5  absolute left-[-10vw] animate-size1 "></span>
      <span className=" h-screen w-[27vw] bg-black/5  absolute left-[-10vw] animate-size2 "></span>
      <span className=" h-screen w-[20vw] bg-black/5  absolute left-[-10vw] animate-size3 "></span>
